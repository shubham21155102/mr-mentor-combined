                                                        ...
                                                        <table class="heading_block block-3" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                                                            <tr>
                                                                <td class="pad" style="padding-bottom:10px;padding-left:30px;padding-right:30px;padding-top:10px;text-align:center;width:100%;">
                                                                    <h1 style="margin: 0; color: #404040; direction: ltr; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 22px; font-weight: 700; letter-spacing: normal; line-height: 120%; text-align: left; margin-top: 0; margin-bottom: 0;"><strong>Verify Your Email Address</strong></h1>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                            ...
                                                            <tr>
                                                                <td class="pad" style="padding-bottom:10px;padding-left:30px;padding-right:30px;padding-top:15px;">
                                                                    <div style="color:#777777;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:14px;line-height:180%;text-align:left;mso-line-height-alt:25.2px;">
                                                                        <p style="margin: 0; margin-bottom: 1px;">Welcome to <strong>MY ANALYTICS SCHOOL</strong>!</p>
                                                                        <p style="margin: 0; margin-bottom: 1px;">&nbsp;</p>
                                                                        <p style="margin: 0; margin-bottom: 1px;">Thank you for signing up with us. To complete your registration and verify your email address, please use the following One-Time Password (OTP):</p>
                                                                        <p style="margin: 0; margin-bottom: 1px;">&nbsp;</p>
                                                                        <p style="margin: 0; margin-bottom: 1px; text-align: center;">
                                                                            <span style="background-color: #f0f0f0; padding: 15px 30px; font-size: 28px; font-weight: bold; letter-spacing: 5px; color: #1a97a4; border-radius: 5px; display: inline-block;">${otp}</span>
                                                                        </p>
                                                                        <p style="margin: 0; margin-bottom: 1px;">&nbsp;</p>
                                                                        <p style="margin: 0; margin-bottom: 1px;"><strong>Important:</strong> This OTP is valid for <strong>10 minutes</strong> only. Please enter it on the verification page to complete your registration.</p>
                                                                        <p style="margin: 0; margin-bottom: 1px;">&nbsp;</p>
                                                                        <p style="margin: 0; margin-bottom: 1px;">If you didn't request this registration, please ignore this email or contact our support team.</p>
                                                                        <p style="margin: 0; margin-bottom: 1px;">&nbsp;</p>
                                                                        <p style="margin: 0; margin-bottom: 1px;">For any queries please contact <a href="mailto:info@myanalyticsschool@gmail.com" target="_blank" style="text-decoration: none; color: #1a97a4;" rel="noopener">info@myanalyticsschool@gmail.com</a></p>
                                                                        <p style="margin: 0; margin-bottom: 1px;">&nbsp;</p>
                                                                        <p style="margin: 0; margin-bottom: 1px;">Best Regards,</p>
                                                                            ...
                                                                            <td class="alignment" style="vertical-align: middle; text-align: center;"><!--[if vml]><table align="left" cellpadding="0" cellspacing="0" role="presentation" style="display:inline-block;padding-left:0px;padding-right:0px;mso-table-lspace: 0pt;mso-table-rspace: 0pt;"><![endif]-->
                                                                                ...
                                                                                <table class="icons-inner" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; display: inline-block; margin-right: -4px; padding-left: 0px; padding-right: 0px;" cellpadding="0" cellspacing="0" role="presentation"><!--<![endif]-->
                                                                                    <tr style="display: flex; align-items: center; ">
                                                                                        <td style="font-family: 'Inter', sans-serif; font-size: 14px; color: #777777; vertical-align: middle; letter-spacing: undefined; text-align: center;"><a href="https://www.myanalyticsschool.com/" target="_blank" style="color: #1e0e4b; text-decoration: none;">MY ANALYTICS SCHOOL &#169; 2025</a></td>
                                                                                    </tr>
                                                                                </table>
                                                                            </td>
                                                                        </tr>
...
export default SignupOtpEmailTemplate;
