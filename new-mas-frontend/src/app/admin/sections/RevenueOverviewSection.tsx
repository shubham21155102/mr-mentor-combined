...
export const RevenueOverviewSection = ({ revenueTrend }: RevenueOverviewProps): JSX.Element => {
  const revenueData = revenueTrend.map(item => ({
    day: item.day,
    revenue: item.value / 1000, // Convert to K
  }));
  return (
    <Card className="flex flex-col items-start gap-2 p-6 rounded-2xl overflow-hidden bg-[linear-gradient(180deg,rgba(163,255,229,0.1)_0%,rgba(0,147,163,0.1)_79%)] border-0">
