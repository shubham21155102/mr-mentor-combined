...
const TokenPurchaseBackground= (props: Props) => {
  return (
    <div>
        <div className="absolute flex h-[0px] items-center justify-center translate-x-[-50%] translate-y-[-50%] w-[0px]"
            ...
            <div className="absolute flex items-center justify-center"
              ...
              <Image src="/mas_equivalent_coin.svg" alt="Token Visual" width={188} height={188} />
            </div>
    </div>
  )
}

export default TokenPurchaseBackground