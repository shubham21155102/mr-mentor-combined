...
interface UpdateMentorModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (mentorData: MentorFormData) => void;
...
const UpdateMentorModal: React.FC<UpdateMentorModalProps> = ({
  isOpen,
  onClose,
  onSubmit,
  initialData,
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto pointer-events-none">
        <div className="bg-[#c4c4c4] rounded-3xl shadow-2xl w-full max-w-5xl my-8 pointer-events-auto">
          ...
          <div className="relative px-6 py-6 flex items-center justify-center">
            <h2 className="text-2xl font-bold text-black">Update Expert</h2>
            <button
              onClick={onClose}
